...
// Effendi et al. (SOAP/PLDI 2025). Hub-module fallback triggers when any changed
// function has ≥50 callers.
...
// The Joern HTTP client (internal/pattern/joern) is the only implementation.
//
// Both Path A and Path B acquire a Graph from joern.Client.Graph() immediately
