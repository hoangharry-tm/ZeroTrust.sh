...
// buildPrompt assembles the B5 analysis prompt: SCL+CFP+AIP evidence, an
// externalized step-by-step reasoning scaffold, and few-shot calibration
// examples. This is the one prompt strategy — no per-model tiers.
