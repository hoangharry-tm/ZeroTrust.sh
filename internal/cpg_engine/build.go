...
// testFileExcludeRegex returns a regex matching conventional test-file
// patterns. It matches both filename suffixes (Test.java, Spec.scala, etc.)
...
// Ensure joernGraph satisfies Graph at compile time.
var _ Graph = (*joernGraph)(nil)
