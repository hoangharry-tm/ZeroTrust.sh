...
- [type TreeRenderer](<#TreeRenderer>)
  - [func NewTreeRenderer\(\) \*TreeRenderer](<#NewTreeRenderer>)
  - [func \(r \*TreeRenderer\) ExitCode\(\) int](<#TreeRenderer.ExitCode>)
  - [func \(r \*TreeRenderer\) Render\(ctx context.Context, ch \<\-chan Event\) error](<#TreeRenderer.Render>)
...
Renderer consumes pipeline events and drives the CLI display for one scan. Implementations: MinimalRenderer, TreeRenderer, TUIRenderer.
...
<a name="TreeRenderer"></a>
## type [TreeRenderer](<https://github.com/hoangharry-tm/ZeroTrust.sh/blob/main/internal/output/tree.go#L34-L41>)

TreeRenderer writes a tree\-structured, coloured log stream to stdout. It is the default mode when stdout is a TTY. Unlike the TUI it does not use an alternate screen — output scrolls naturally in the terminal.
...
<a name="NewTreeRenderer"></a>
### func [NewTreeRenderer](<https://github.com/hoangharry-tm/ZeroTrust.sh/blob/main/internal/output/tree.go#L57>)
...
<a name="TreeRenderer.ExitCode"></a>
### func \(\*TreeRenderer\) [ExitCode](<https://github.com/hoangharry-tm/ZeroTrust.sh/blob/main/internal/output/tree.go#L65>)

```go
func (r *TreeRenderer) ExitCode() int
```

ExitCode implements Renderer.

<a name="TreeRenderer.Render"></a>
### func \(\*TreeRenderer\) [Render](<https://github.com/hoangharry-tm/ZeroTrust.sh/blob/main/internal/output/tree.go#L68>)
