...
This project is indexed by GitNexus as **ZeroTrust.sh** (5110 symbols, 10711 relationships, 167 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
